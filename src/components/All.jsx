...
export default function All() {
  return (
            <div className="tab-container">
                <motion.div data-aos="fade-right" initial={{opacity:0, translateX:-50}} whileInView={{opacity:1,translateX:0, transition:{delay:0.2, duration:1}}} viewport={{once:false, amount: .5}} data-bs-toggle="modal" data-bs-target="#exampleModal" >
                ...
                <motion.div data-aos="fade-right" initial={{opacity:0, translateX:-50}} whileInView={{opacity:1,translateX:0, transition:{delay:0.2, duration:1}}} viewport={{once:false, amount: .5}} data-bs-toggle="modal" data-bs-target="#exampleModal1">
                  <div className="tab-content">
                    <img alt="portfolio project demo" src='/assets/images/vimcorn.png' loading="lazy" style={{color: "transparent"}} />
                    <h3><span className="conent-title">VIM CORN project</span></h3>
                  </div>
                </motion.div>
                ...
                <motion.div data-aos="fade-right" initial={{opacity:0, translateX:-50}} whileInView={{opacity:1,translateX:0, transition:{delay:0.2, duration:1}}} viewport={{once:false, amount: .5}} data-aos-delay="200" className="aos-init" data-bs-toggle="modal" data-bs-target="#exampleModal8">
                  <div className="tab-content">
                    <img alt="portfolio project demo" src='/assets/images/igrow++.png' loading="lazy" style={{color: "transparent"}} />
                    <h3><span className="conent-title">I GROW++ project</span></h3>
                  </div>
                </motion.div>
